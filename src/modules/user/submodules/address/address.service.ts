...
export class AddressService {
  ...
  static async create(userId: string, data: CreateAddressDto): Promise<Address> {
  ...
  static async update(userId: string, id: string, data: UpdateAddressDto): Promise<Address> {
